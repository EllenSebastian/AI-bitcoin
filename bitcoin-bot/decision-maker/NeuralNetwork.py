...
class NeuralNetwork:
	...
	# priceData is a hash between timetamps and prices, 
	def __init__(self, priceData, endTimeStamp, windowSize = 10, numFeatures = 100, numDataPoints = 1000, frequency = 3600, nnType = 'ff', whichData=['price'], normalize=True):
	# nntype is ff, elman
