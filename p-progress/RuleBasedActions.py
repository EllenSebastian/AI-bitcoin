...
class RuleBasedActionPicker: 
	...
	def simulate_ts(self, ts, pricePrediction, priceData): 
		...
		sell = priceData[ts] > (self.boughtAt + 0.5) # sell if current price produces profit # TODO account for fees 
		buy = pricePrediction > priceData[ts] # buy if the price will go up 
		"""
